...
procedure ListarUsuarioFone(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
begin
  ...
  // Rotas automação
  THorse.get('/usuarios/whatsapp/:numero', ListarUsuarioFone);
end;
