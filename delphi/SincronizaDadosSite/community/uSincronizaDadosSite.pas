...
begin
  ...
  try
    ...
    on E: EFDDBEngineException do
      case E.Kind of
        ...
        memo1.lines.add('Ocorreu um erro ao conectar com banco de dados, feche o sistema e abra novamente');
  ...
  begin
    memo1.lines.add('Conexão com a base de dados falhou, se o erro persistir contate o suporte');
    exit;
  end;
