unit uSincronizaDadosCategoria;
...
type
  TFSincronizaDadosCategoria = class(TForm)
    edtzone: TEdit;
    edtczone: TEdit;
    edtname: TEdit;
    edttipo: TEdit;
...
var
  FSincronizaDadosCategoria: TFSincronizaDadosCategoria;
...
procedure TFSincronizaDadosCategoria.Button1Click(Sender: TObject);
begin
  try
...
procedure TFSincronizaDadosCategoria.Button3Click(Sender: TObject);
var
...
procedure TFSincronizaDadosCategoria.Button4Click(Sender: TObject);
begin
...
procedure TFSincronizaDadosCategoria.Button5Click(Sender: TObject);
var
  Hora, Min, Sec,MSec:Word;
begin
...
procedure TFSincronizaDadosCategoria.Button6Click(Sender: TObject);
var
...
procedure TFSincronizaDadosCategoria.Button7Click(Sender: TObject);
var
...
procedure TFSincronizaDadosCategoria.clearMemory;
var
   MainHandle : THandle;
begin
   try
...
procedure TFSincronizaDadosCategoria.desmontaNomeArquivo(nomeArquivo: string; out nome: string;
  extensao: string);
var pos:integer;
begin
...
procedure TFSincronizaDadosCategoria.FDConnBeforeConnect(Sender: TObject);
begin
...
procedure TFSincronizaDadosCategoria.FormCreate(Sender: TObject);
begin
     edtzone.text := '';
		 edtczone.Text := '';
		 edtname.Text := '';
